export default class BudgetCalculator {
    constructor(querySelectorString) {
        ...
        this.root.innerHTML = BudgetCalculator.html();
    ...
    load() {
        const entries = JSON.parse(localStorage.getItem("budget-calculator-entries") || "[]");
    ...
    save() {
        ...
        localStorage.setItem("budget-calculator-entries", JSON.stringify(data));
        this.updateSummary();
    }

    addEntry(entry = {}) {
        this.root.querySelector(".entries").insertAdjacentHTML("beforeend", BudgetCalculator.entryHtml());
